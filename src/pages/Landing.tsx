...
const Landing = () => (
  <>
    <SeoHead
      ...
      description="Midwess builds PgPaw and Worldant: database-first runtime infrastructure for PostgreSQL-backed state, durable workflows, and filesystem-authored application functions."
      path="/"
