...
export const PostPopup = ({ post, onClose }: PostPopupProps) => {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 md:p-6 lg:p-8">
      ...
      <div
        className="bg-card relative flex h-full max-h-[90vh] w-full max-w-(--breakpoint-xl) flex-col overflow-hidden rounded-[2rem] border border-border shadow-2xl transition-all duration-200"
      >
        {/* Header */}
        ...
        <div className="flex-1 overflow-y-auto scrollbar-thin scrollbar-thumb-border">
          <div className="mx-auto flex w-full max-w-4xl flex-col px-8 py-10 md:px-12 lg:px-20">
            {/* Main Content */}
